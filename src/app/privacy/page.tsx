    ...
    <div className="min-h-screen bg-white">
      <div className="mx-auto max-w-4xl px-4 py-8">
        <article className="prose prose-slate prose-headings:font-semibold prose-h1:text-4xl prose-h2:text-2xl prose-h3:text-xl prose-h4:text-lg prose-p:text-gray-600 prose-li:text-gray-600 max-w-none">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Study Rooms.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Study Rooms, accessible from{" "}
                <a
          ...
          <p>
            You&apos;re advised to review this Privacy Policy periodically for
          ...
          <ul>
            <li>
              ...
              <a
                href="https://study-room-sooty.vercel.app/contact"
                rel="external nofollow noopener"
                target="_blank"
              >
