      ...
      <div className="mx-auto max-w-4xl px-4 py-8">
        <article className="prose prose-slate max-w-none prose-headings:font-semibold prose-h1:text-4xl prose-h2:text-2xl prose-h3:text-xl prose-h4:text-lg prose-p:text-gray-600 prose-li:text-gray-600">
          ...
          <p>
            ...
            calendar features. The platform enables users to create and join
            study sessions, collaborate with other learners, and manage their
          ...
          <p>
            ...
            (&quot;you&quot;), and Study Rooms, concerning your access to and
          ...
          <p>
            ...
            and (8) your use of the Services will not violate any applicable law
            or regulation.
          </p>
          <p>
          ...
          <p>
            ...
            state and federal courts located in United States, New York , and
