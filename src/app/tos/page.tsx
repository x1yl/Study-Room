  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      <article className="prose prose-slate max-w-none prose-headings:font-semibold prose-h1:text-4xl prose-h2:text-2xl prose-h3:text-xl prose-h4:text-lg prose-p:text-gray-600 prose-li:text-gray-600">
        ...
        <p>
          Study Rooms is a virtual learning platform that provides study rooms
          with productivity tools, including timers, chat functionality, and
          calendar features. The platform enables users to create and join study
          sessions, collaborate with other learners, and manage their study
          activities through our digital interface.
        </p>
        ...
        <p>
          ...
          and Study Rooms, concerning your access to and use of the Services.
        ...
        <p>
          ...
          if a minor, you have received parental permission to use the Services;
          ...
          use the Services for any illegal or unauthorized purpose; and (8) your
        ...
        <p>
          ...
          place in United States, New York . Except as otherwise provided
        ...
        <p>
          ...
          and federal courts located in United States, New York , and the
