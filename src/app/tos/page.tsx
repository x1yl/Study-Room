  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      <article className="prose prose-slate max-w-none prose-headings:font-semibold prose-h1:text-4xl prose-h2:text-2xl prose-h3:text-xl prose-h4:text-lg prose-p:text-gray-600 prose-li:text-gray-600">
        ...
        <p>
          We are Study Rooms ("<strong>Company</strong>," "<strong>we</strong>," "
        ...
        <p>
          ...
          <a
            href="https://study-room-sooty.vercel.app/"
            target="_blank"
            rel="noopener noreferrer"
          >
            https://study-room-sooty.vercel.app/
          </a>{" "}
        ...
        <p>
          Study Rooms is a virtual learning platform that provides study rooms with 
          productivity tools, including timers, chat functionality, and calendar features. 
          The platform enables users to create and join study sessions, collaborate with 
          other learners, and manage their study activities through our digital interface.
        </p>

        <p>
          You can contact us by email at life23243@tutanota.com.
        </p>
        ...
        <p>
          ...
          Study Rooms, concerning your access to and use of the Services. You agree 
        ...
        <p>
          ...
          competition laws) and treaties in the United States and
          around the world.
        </p>
        <p>
          The Content and Marks are provided in or through the Services
          "AS IS" for your personal,
        ...
        <p>
          ...
          please address your request to: life23243@tutanota.com.
        ...
        <p>(1) all registration information you submit will be true,
        ...
        <p>(3) you have the legal capacity and you agree to comply with these
          Legal Terms;
        </p>
        <p>(4) you are not under the age of 13;</p>
        <p>(5) you are not a minor in the jurisdiction in which you reside
        ...
        <p>
          ...
          be viewable by other users of the Services and
        ...
        <ul>
          ...
          <li>
            ...
            authorize us, the Services, and other users
        ...
        <h2 id="socialmedia">8. SOCIAL MEDIA</h2>
        <p>
          ...
          Third-Party Account, without breach by you
          of any of the terms and conditions that govern your use of
          the applicable Third-Party Account, and
          without obligating us to pay any fees or making us subject
          to any usage limitations imposed by the third-party
          ...
          and through the Services via your account, including
          without limitation any friend lists and (2) we may submit
          to and receive from your Third-Party Account
          ...
          such Third-Party Account is terminated by the
          third-party service provider, then Social Network Content
          may no longer be available on and through the Services.
          ...
          to, for accuracy, legality, or non-infringement, and we
          ...
          Third-Party Account by contacting us using
        ...
        <h2 id="thirdparty">9. THIRD-PARTY WEBSITES AND CONTENT</h2>
        <p>
          ...
          policies of or contained in the Third-Party Websites
          or the Third-Party Content. Inclusion of, linking to,
        ...
        <p>
          ...
          <strong>
            &nbsp;
            <a
              href="https://study-room-sooty.vercel.app/privacy"
              target="_blank"
              rel="noopener noreferrer"
            >
              https://study-room-sooty.vercel.app/privacy
            </a>
          </strong>
        ...
        <p>
          ...
          state and federal courts. Application
        ...
        <p>
          ...
          arising out of:
          (1) use of the Services; (2) breach
          of these Legal Terms; (3) any breach of your
          ...
          expense, with our defense of such
        ...
        <p>
          ...
          the electronic form of these Legal Terms and the lack of signing
